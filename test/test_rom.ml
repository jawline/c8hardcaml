...
let%expect_test "Trip 8" =
  ...
  [%expect
    {|
      ((core
        ((in_execute 1) (in_fetch 1) (op 1111000000000111)
         (working_op 1111000000000111)
         (registers
          ((pc 001110111110) (i 010000110000) (sp 000000101010)
           (registers
            (00000010 00001100 00010010 00000000 00000000 00000000 00000000
             00000000 00000000 00000000 00000000 00000000 00000000 00000100
             00000000 00000000))))
         (fetch_finished 1) (fetch_cycle 10) (last_op 0001001110111110)
         (executor_done 1) (executor_error 0)
         (memory
          ((read_address 0000000000000000) (write_enable 0)
           (write_address 0000000000000000) (write_data 00000000)))
