...
let%expect_test "Particle" =
  ...
  [%expect
    {|
      ...
      ((core
        ((in_execute 1) (in_fetch 0) (op 1111001000011110)
         (working_op 1111001000000000)
         (registers
          ((pc 001000001010) (i 001100100001) (sp 00000000000000000000000000000000)
           (registers
            (00000000 00000000 00001000 00000000 00000000 00000000 00000000
             00000000 00000000 00000000 00000000 00000000 00000000 00000000
             00000000 00000000))))
         (fetch_finished 0) (fetch_cycle 00) (last_op 1111001000011110)
