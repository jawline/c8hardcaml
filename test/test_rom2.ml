...
let%expect_test "Airplane" =
  ...
  test_rom
    ~print_on_exit:false
    ~print_on_cycle:false
    ~print_at_cycles:[ rough_cycles_per_second * 10 ]
    ~rom_file
    ~create;
  [%expect.unreachable];
  return ()
  ...
  (monitor.ml.Error "Error in ROM"
    ("Raised at Base__Error.raise in file \"src/error.ml\" (inlined), line 9, characters 14-30"
      ...
      "Called from C8_test__Helper.test_rom.(fun) in file \"test/helper.ml\", line 139, characters 2-743"
      "Called from Stdlib__list.iter in file \"list.ml\", line 110, characters 12-15"
      "Called from Base__List0.iter in file \"src/list0.ml\" (inlined), line 25, characters 16-35"
      "Called from C8_test__Helper.test_rom in file \"test/helper.ml\", line 137, characters 2-925"
      "Called from C8_test__Test_rom2.(fun) in file \"test/test_rom2.ml\", line 57, characters 2-142"
  ...
  ERROR: ((core
    ((in_execute 1) (in_fetch 0) (op 1111000100011000)
     ...
     (registers
      ((pc 001000010110) (i 001101010100) (sp 000000000000)
       (registers
        (00110000 00000001 00000000 00000001 00011101 00000000 00000000
         00000000 00000000 00000000 00000000 00000100 00000001 00000000
         00000010 00000000))))
     (fetch_finished 0) (fetch_cycle 00) (last_op 1111000100011000)
